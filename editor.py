...
class TextEditor:
    ...
    def __init__(self, root):
        ...
        self.root = root
        # Title of the window
        self.root.title("axelyron-EDITOR")
        # Window Geometry
        self.root.geometry("1100x600+150+150")
        ...
        # Initializing Status
        self.status.set("Welcome To axelyron-EDITOR")
        # Creating Menubar
    ...
    def infoabout(self):
        messagebox.showinfo(
            "About Text Editor", "axelyron-editor is a simple text editor included in the Axelyron_OS")
